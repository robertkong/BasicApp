  ...
  requirejs.config(
    {
      ...
      */
      // injector:mainReleasePaths
      {
        ...
        'ckeditor': 'libs/ckeditor/ckeditor5-editor-classic.js'
      }
      // endinjector
    }
  );
 ...
 */
require(['ojs/ojbootstrap', 'knockout', 'appController', 'text!existingComments.json', 'ojs/ojknockout', 'ojs/ojbutton', 'ojs/ojtoolbar', 'ojs/ojmenu', 'ckeditor4'],
  function (Bootstrap, ko, app, existingComments) { // this callback gets executed when all required modules are loaded
